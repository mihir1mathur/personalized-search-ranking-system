...
st.caption("These parameters are passed straight through to the backend on your "
           "next search. Defaults mirror the server's configured values.")
...
with st.container(border=True):
    st.caption("How much to trust keyword (α, BM25) vs meaning (β, embeddings). "
               "The recommended mix is α=0.4, β=0.6.")
    c1, c2 = st.columns(2)
